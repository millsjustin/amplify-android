...
data class TransferRecord(
    ...
    var transferUtilityOptions: TransferOptions? = null,
    var submittedTask: Future<*>? = null
) {
    companion object {
        @JvmStatic
        fun updateFromDB(c: Cursor): TransferRecord {
            ...
            return TransferRecord(id).apply {
                ...
                this.type = TransferType.valueOf(c.getString(c.getColumnIndexOrThrow(TransferTable.COLUMN_TYPE)))
                ...
                this.transferUtilityOptions = gson.fromJson(c.getString(c.getColumnIndexOrThrow(TransferTable.COLUMN_TRANSFER_UTILITY_OPTIONS)), TransferOptions::class.java)
            }
        }
    }
}
