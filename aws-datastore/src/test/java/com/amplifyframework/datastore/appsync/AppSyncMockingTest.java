...
public final class AppSyncMockingTest {
    ...
    public void mockSuccessResponseForUpdate() {
        ModelMetadata updatedMetadata =
            new ModelMetadata(StrawMen.TONY_MODEL.getId(),
                    StrawMen.TONY_MODEL.getModelName(),
                    false,
                    2,
    ...
    static final class StrawMen {
        ...
        static final ModelMetadata JOE_METADATA =
            new ModelMetadata(JOE_MODEL.getId(), JOE_MODEL.getModelName(), false, 1, Temporal.Timestamp.now());
        ...
        static final ModelMetadata TONY_METADATA =
            new ModelMetadata(TONY_MODEL.getId(), TONY_MODEL.getModelName(), false, 1, Temporal.Timestamp.now());
