...
public final class MergerTest {
    ...
    public void mergeDeletionForExistingItem() throws DataStoreException, InterruptedException {
        ...
        ModelMetadata originalMetadata =
            new ModelMetadata(blogOwner.getId(), blogOwner.getModelName(), false, 1, Temporal.Timestamp.now());
        ...
        ModelMetadata deletionMetadata =
            new ModelMetadata(blogOwner.getId(), blogOwner.getModelName(), true, 2, Temporal.Timestamp.now());
    ...
    public void mergeDeletionForNotExistingItem() throws DataStoreException, InterruptedException {
        ...
        ModelMetadata deletionMetadata =
            new ModelMetadata(blogOwner.getId(), blogOwner.getModelName(), true, 1, Temporal.Timestamp.now());
        TestObserver<Void> observer =
            merger.merge(new ModelWithMetadata<>(blogOwner, deletionMetadata)).test();
        assertTrue(observer.await(REASONABLE_WAIT_TIME, TimeUnit.MILLISECONDS));
        observer.assertNoErrors().assertComplete();
    ...
    public void mergeSaveForExistingItem() throws DataStoreException, InterruptedException {
        ...
        BlogOwner originalModel = BlogOwner.builder()
            ...
            .build();
        ModelMetadata originalMetadata =
            new ModelMetadata(originalModel.getId(), originalModel.getModelName(), false, 1, Temporal.Timestamp.now());
        ...
        ModelMetadata updatedMetadata =
            new ModelMetadata(originalMetadata.getId(),
                    originalMetadata.getModelName(),
                    false,
                    2,
    ...
    public void itemIsNotMergedWhenOutboxHasPendingMutation() throws AmplifyException, InterruptedException {
        ...
        ModelMetadata cloudMetadata =
            new ModelMetadata(knownId, blogOwner.getModelName(), true, 2, Temporal.Timestamp.now());
    ...
    public void itemWithLowerVersionIsNotMerged() throws DataStoreException, InterruptedException {
        ...
        ModelMetadata existingMetadata =
            new ModelMetadata(existingModel.getId(), existingModel.getModelName(), false, 55, Temporal.Timestamp.now());
        ...
        ModelMetadata lowerVersionMetadata =
            new ModelMetadata(incomingModel.getId(), incomingModel.getModelName(), false, 33, Temporal.Timestamp.now());
    ...
    public void itemWithoutVersionIsNotMerged() throws DataStoreException, InterruptedException {
        ...
        BlogOwner existingModel = BlogOwner.builder()
            ...
            .build();
        ModelMetadata existingMetadata =
            new ModelMetadata(existingModel.getId(), existingModel.getModelName(), false, 1, Temporal.Timestamp.now());
        storageAdapter.save(existingModel, existingMetadata);
        ...
        BlogOwner incomingModel = existingModel.copyOfBuilder()
            .name("Cornelius Daniels, but woke af, now.")
            .build();
        ModelMetadata metadataWithoutVersion =
            new ModelMetadata(incomingModel.getId(), incomingModel.getModelName(), null, null, null);
    ...
    public void orphanedItemIsNotMerged() throws DataStoreException, InterruptedException {
        ...
        Blog orphanedBlog = Blog.builder()
                ...
                .build();
        ModelMetadata metadata =
            new ModelMetadata(orphanedBlog.getId(), orphanedBlog.getModelName(), false, 1, Temporal.Timestamp.now());
