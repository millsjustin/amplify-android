...
@VisibleForTesting
internal class TransferDatabaseHelper(private val context: Context) :
    ...
    companion object {
        ...
        private val LOGGER = LogFactory.getLog(TransferDatabaseHelper::class.java)
    }
        ...
        return when (uriType) {
            ...
            TRANSFER_ID -> {
                ...
                if (TextUtils.isEmpty(selection)) {
                    ...
                    database.delete(
                            TransferTable.TABLE_TRANSFER,
                            "${TransferTable.COLUMN_ID}=$id and $selection",
                            selectionArgs
                        )
                }
            }
