...
public class PinpointContext implements Serializable {
    ...
    private final PinpointClient pinpointServiceClient;
    ...
    public PinpointContext(final PinpointClient pinpointServiceClient,
        ...
        //TODO: find out equivalent in the Java SDK
//        pinpointServiceClient.addRequestHandler(new SDKInfoHandler(sdkInfo));
    ...
    public PinpointClient getPinpointServiceClient() {
...
//            connectivity.getNetworkCapabilities().hasTransport(TRAN)
//            final NetworkInfo networkInfo = connectivity.call.getActiveNetworkInfo();
