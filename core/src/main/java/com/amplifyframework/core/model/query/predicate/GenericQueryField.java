 ...
 */
public class GenericQueryField<T> {
     ...
     */
    public GenericQueryField(String fieldName) {
     ...
     */
    public static <T> GenericQueryField<T> genericField(String fieldName) {
        return new GenericQueryField<>(fieldName);
    }
     ...
     */
    public <T> QueryPredicateOperation<T> eq(T value) {
     ...
     */
    public <T> QueryPredicateOperation<T> ne(T value) {
